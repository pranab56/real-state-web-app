...
const PolicySection = ({ index }: { index: number }) => (
  ...
  >
    <h2 className="text-xl md:text-2xl font-bold text-neutral-1">Privacy & Policy</h2>
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#FAF6F2] py-16 md:py-24 text-center mt-8 md:mt-12">
        <div className="container mx-auto px-4 md:px-6 space-y-3 md:space-y-4">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-neutral-1">Privacy & Policy</h1>
